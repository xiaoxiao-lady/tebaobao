<template name="graceSwiper">
	<view>
		<swiper class="grace-swiper" autoplay="true" :indicator-dots="indicatorDots" indicator-color="rgba(255, 255, 255, 1)" indicator-active-color="#FF1212" :style="{height : swiperHeight + 'upx'}" :interval="interval">
			<swiper-item v-for="(item, index) in items" :key="index">
				<navigator :url='item.path' :open-type="item.openType">
					<image :src='item.imgUrl' :id="swiperId + '-item-1'" mode='scaleToFill'></image>
