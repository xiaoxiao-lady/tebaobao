<template name="graceCountd">
	<view class="grace-countdown">
		<view class="grace-countdown-numbers" :style="{borderColor:borderColor, color:fontColor, background:bgrColor}">{{h}}时</view>
		<!-- <view class="grace-countdown-splitor" :style="{color:splitorColor}">:</view> -->
		<view class="grace-countdown-numbers" :style="{borderColor:borderColor, color:fontColor, background:bgrColor}">{{i}}分</view>
		<!-- <view class="grace-countdown-splitor" :style="{color:splitorColor}">:</view> -->
		<view class="grace-countdown-numbers" :style="{borderColor:borderColor, color:fontColor, background:bgrColor}">{{s}}秒</view>
	</view>
</template>
<script>
export default {
