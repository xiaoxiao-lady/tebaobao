        ...
        <view class="setup">
            <view class="per-lists" style="margin-top: 0;">
                <view class="items">
                    ...
                    手机号
                    <input type="number " class="input" v-model="phone" disabled="true" placeholder="请输入手机号" maxlength="11">
                ...
                <view class="items">
                    ...
                    <view class="code-right">
                        ...
                        <text class="itm-color" @click="getszpaypwdcode">{{clickText}}</text>
                    </view>
                </view>
...
export default {
    ...
    methods: {
        ...
        getszpaypwdcode(){
            ...
            this.$http.getszpaypwdcode({phone:this.phone}).then(res=>{
                if(res.status == 200) {
                   this.$toast(res.mess)
                   setId = setInterval(()=>{
                       courr--
        ...
        gethuoquphone(){
            this.$http.gethuoquphone().then(res=>{
                if(res.status == 200) {
